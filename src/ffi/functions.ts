 ...
 * @returns C API関数群
 */
export function declareFunctions(
	lib: IKoffiLib,
): VoicevoxCoreFunctions {
	return {
		// ONNX Runtime関連
		...
		voicevox_mora_validate: lib.func(
			"int32 voicevox_mora_validate(const char* mora_json)",
		),

		// ユーティリティ
		voicevox_get_version: lib.func(
