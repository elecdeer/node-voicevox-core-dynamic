...
describe("VoicevoxError", () => {
  it("should create error with code and message", () => {
    const error = new VoicevoxError(VoicevoxResultCode.GpuSupportError, "GPU is not supported");
  ...
  it("should have correct toString", () => {
    const error = new VoicevoxError(VoicevoxResultCode.ModelNotFoundError, "Model not found");
